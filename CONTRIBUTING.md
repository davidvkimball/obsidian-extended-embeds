...
- This plugin fetches public embed metadata from third-party services (GitHub, Spotify, Open Graph, etc.) only to render the requested embed. Keep network requests limited to what an embed needs.
